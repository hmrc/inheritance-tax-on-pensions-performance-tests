...
//    postEnterNationalInsuranceNumberPageForPsp("AB123456C"),
    ...
    postChangeNamePrOrganisationPageForPsp("PRFirstname", "PRSurname"),
...
//    getIHTPReportSubmittedPageForPsp
  ...
  setup(
    ...
    postPrIndividualNameChangePage("PRFirstname", "PRLastname"), // Usingchangenameurltoavoidaddresslookup
    getCYAPage,
    postCYAPage
//    getPsaDeclarationPage,
//    postPsaDeclarationPage,
